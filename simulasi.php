...
<div class='jumbotron jumbotron-fluid' id='hslPrekdiksinya'>
  <div class='container'>
    <h1 class='display-4 tebal'>Hasil Prediksi Kelulusan Pelamar</h1>
    <p class='lead'>Berikut ini adalah hasil prediksi kelulusan calon pelamar kerja menggunakan metode naive bayes.</p>
  </div>
</div>
";
